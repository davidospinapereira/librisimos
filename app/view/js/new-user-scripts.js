...
function crearPerfil()
{
    ...
    ({
        ...
        {
            // Si el código es de éxito entonces debemos avisar y recargar la página
            if (data == 'NEW_USER_CREATED')
            {
                mensaje('success', '<b>ÉXITO</b><br/>Usuario creado satisfactoriamente.<br/>Esta página será recargada ahora.');
                setTimeout(function() 
                {
                    window.location.href = 'index.php?page=new-user';
                }, 5000);
            }
